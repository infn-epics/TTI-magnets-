...
/* Generated from ../O.Common/streamdeviceSample.dbd */
...
int streamdeviceSample_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/app/TTI-magnets-";
...
/* streamdeviceSample_registerRecordDeviceDriver */
...
static const iocshFuncDef rrddFuncDef = {
    ...
    "Example: streamdeviceSample_registerRecordDeviceDriver pdbbase\n",
};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(streamdeviceSample_registerRecordDeviceDriver(*iocshPpdbbase));
}
